// welp_acc_buffer.hpp - last update : 16 / 01 / 2021
...
namespace welp
{
	...
	template <class Ty, class _Allocator = std::allocator<char>> class acc_const_buffer : private _Allocator
	{
	...
	public:
		...
		inline welp::acc_const_buffer<Ty, _Allocator>& operator<<(const Ty& obj);
		inline welp::acc_const_buffer<Ty, _Allocator>& operator<<(const Ty* obj_ptr) noexcept;
		inline welp::acc_const_buffer<Ty, _Allocator>& operator<(const Ty& obj);
		...
		inline welp::acc_const_buffer<Ty, _Allocator>::iterator begin() const noexcept { return welp::acc_const_buffer<Ty, _Allocator>::iterator(data_ptr); }
		inline welp::acc_const_buffer<Ty, _Allocator>::iterator end() const noexcept { return welp::acc_const_buffer<Ty, _Allocator>::iterator(current_ptr); }
		inline welp::acc_const_buffer<Ty, _Allocator>::iterator cbegin() const noexcept { return welp::acc_const_buffer<Ty, _Allocator>::iterator(data_ptr); }
		inline welp::acc_const_buffer<Ty, _Allocator>::iterator cend() const noexcept { return welp::acc_const_buffer<Ty, _Allocator>::iterator(current_ptr); }

		acc_const_buffer() = default;
		acc_const_buffer(std::size_t instances);
		acc_const_buffer(const welp::acc_const_buffer<Ty, _Allocator>&);
		welp::acc_const_buffer<Ty, _Allocator>& operator=(const welp::acc_const_buffer<Ty, _Allocator>&);
		acc_const_buffer(welp::acc_const_buffer<Ty, _Allocator>&&) noexcept;
		welp::acc_const_buffer<Ty, _Allocator>& operator=(welp::acc_const_buffer<Ty, _Allocator>&&) noexcept;
		~acc_const_buffer();
	...
	public:
		...
		public:
			...
			inline const Ty& operator*() noexcept
			{
				if (internal_ptr->storage_ptr != nullptr) { return *(internal_ptr->storage_ptr); }
				else { return internal_ptr->storage; }
			}
			...
			inline const Ty& operator[](std::ptrdiff_t offset) noexcept
			{
				storage_cell* temp_ptr = internal_ptr + offset;
				if (temp_ptr->storage_ptr != nullptr) { return *(temp_ptr->storage_ptr); }
				else { return temp_ptr->storage; }
			...
			inline welp::acc_const_buffer<Ty, _Allocator>::iterator& operator+=(std::ptrdiff_t offset) noexcept { internal_ptr += offset; return *this; }
			inline welp::acc_const_buffer<Ty, _Allocator>::iterator& operator++() noexcept { internal_ptr++; return *this; }
			inline welp::acc_const_buffer<Ty, _Allocator>::iterator operator++(int) noexcept {
				welp::acc_const_buffer<Ty, _Allocator>::iterator temp_iterator = *this;
				internal_ptr++; return temp_iterator;
			}
			...
			inline welp::acc_const_buffer<Ty, _Allocator>::iterator operator+(std::size_t offset) const noexcept {
				return welp::acc_const_buffer<Ty, _Allocator>::iterator(internal_ptr + offset);
			}
			inline welp::acc_const_buffer<Ty, _Allocator>::iterator operator-(std::size_t offset) const noexcept {
				return welp::acc_const_buffer<Ty, _Allocator>::iterator(internal_ptr - offset);
			}
			inline std::ptrdiff_t operator-(const welp::acc_const_buffer<Ty, _Allocator>::iterator& rhs) const noexcept {
				return internal_ptr - rhs.internal_ptr;
			}

			inline bool operator==(const welp::acc_const_buffer<Ty, _Allocator>::iterator& rhs) const noexcept { return internal_ptr == rhs.internal_ptr; }
			inline bool operator!=(const welp::acc_const_buffer<Ty, _Allocator>::iterator& rhs) const noexcept { return internal_ptr != rhs.internal_ptr; }
			inline bool operator<(const welp::acc_const_buffer<Ty, _Allocator>::iterator& rhs) const noexcept { return internal_ptr < rhs.internal_ptr; }
			inline bool operator>(const welp::acc_const_buffer<Ty, _Allocator>::iterator& rhs) const noexcept { return internal_ptr > rhs.internal_ptr; }
			inline bool operator<=(const welp::acc_const_buffer<Ty, _Allocator>::iterator& rhs) const noexcept { return internal_ptr <= rhs.internal_ptr; }
			...
			iterator() = default;
			iterator(const storage_cell* ptr) : internal_ptr(ptr) {}
			iterator(const welp::acc_const_buffer<Ty, _Allocator>::iterator&) = default;
			welp::acc_const_buffer<Ty, _Allocator>::iterator& operator=(const welp::acc_const_buffer<Ty, _Allocator>::iterator&) = default;
			iterator(welp::acc_const_buffer<Ty, _Allocator>::iterator&&) = default;
			welp::acc_const_buffer<Ty, _Allocator>::iterator& operator=(welp::acc_const_buffer<Ty, _Allocator>::iterator&&) = default;
			~iterator() = default;

		private:

			const storage_cell* internal_ptr;
		};
	...
	private:
		...
		public:
			...
			storage_cell() = default;
			storage_cell(const welp::acc_const_buffer<Ty, _Allocator>::storage_cell&) = default;
			welp::acc_const_buffer<Ty, _Allocator>::storage_cell& operator=(const welp::acc_const_buffer<Ty, _Allocator>::storage_cell&) = default;
			storage_cell(welp::acc_const_buffer<Ty, _Allocator>::storage_cell&&) = default;
			welp::acc_const_buffer<Ty, _Allocator>::storage_cell& operator=(welp::acc_const_buffer<Ty, _Allocator>::storage_cell&&) = default;
			~storage_cell() = default;
		};
	};
}
...
template <class Ty, class _Allocator>
inline void welp::acc_buffer<Ty, _Allocator>::delete_buffer()
{
	if (data_ptr != nullptr)
	{
...
template <class Ty, class _Allocator>
inline welp::acc_const_buffer<Ty, _Allocator>& welp::acc_const_buffer<Ty, _Allocator>::operator<<(const Ty& obj)
{
#ifdef WELP_ACC_BUFFER_DEBUG_MODE
	assert(current_ptr < data_ptr + max_number_of_cells);
#endif // WELP_ACC_BUFFER_DEBUG_MODE
...
template <class Ty, class _Allocator>
inline welp::acc_const_buffer<Ty, _Allocator>& welp::acc_const_buffer<Ty, _Allocator>::operator<<(const Ty* obj_ptr) noexcept
{
#ifdef WELP_ACC_BUFFER_DEBUG_MODE
	assert(current_ptr < data_ptr + max_number_of_cells);
#endif // WELP_ACC_BUFFER_DEBUG_MODE
...
template <class Ty, class _Allocator>
inline const Ty& welp::acc_const_buffer<Ty, _Allocator>::operator[](std::size_t offset) const noexcept
{
#ifdef WELP_ACC_BUFFER_DEBUG_MODE
	assert(data_ptr + offset < current_ptr);
#endif // WELP_ACC_BUFFER_DEBUG_MODE
...
template <class Ty, class _Allocator>
inline std::size_t welp::acc_const_buffer<Ty, _Allocator>::size() const noexcept
{
	return static_cast<std::size_t>(current_ptr - data_ptr);
}

template <class Ty, class _Allocator>
constexpr std::size_t welp::acc_const_buffer<Ty, _Allocator>::capacity() const noexcept
{
	return max_number_of_cells;
}

template <class Ty, class _Allocator>
inline void welp::acc_const_buffer<Ty, _Allocator>::pop_back()
{
	if (current_ptr != data_ptr)
	{
		current_ptr;
...
template <class Ty, class _Allocator>
inline void welp::acc_const_buffer<Ty, _Allocator>::pop_back(std::size_t instances)
{
	std::size_t n = static_cast<std::size_t>(current_ptr - data_ptr);
	for (n = (instances < n) ? instances : n; n > 0; n--)
	{
...
template <class Ty, class _Allocator>
inline bool welp::acc_const_buffer<Ty, _Allocator>::new_buffer(std::size_t instances)
{
	delete_buffer();
...
template <class Ty, class _Allocator>
inline void welp::acc_const_buffer<Ty, _Allocator>::delete_buffer()
{
	if (data_ptr != nullptr)
	{
		storage_cell* ptr = data_ptr + (max_number_of_cells - 1);
...
template <class Ty, class _Allocator>
welp::acc_const_buffer<Ty, _Allocator>::acc_const_buffer(std::size_t instances)
{
	new_buffer(instances);
}

template <class Ty, class _Allocator>
welp::acc_const_buffer<Ty, _Allocator>::acc_const_buffer(const welp::acc_const_buffer<Ty, _Allocator>& rhs)
{
	new_buffer(rhs.capacity());
...
template <class Ty, class _Allocator>
welp::acc_const_buffer<Ty, _Allocator>& welp::acc_const_buffer<Ty, _Allocator>::operator=(const welp::acc_const_buffer<Ty, _Allocator>& rhs)
{
	delete_buffer();
	new_buffer(rhs.capacity());
...
template <class Ty, class _Allocator>
welp::acc_const_buffer<Ty, _Allocator>::acc_const_buffer(welp::acc_const_buffer<Ty, _Allocator>&& rhs) noexcept
	: current_ptr(rhs.current_ptr), data_ptr(rhs.data_ptr), max_number_of_cells(rhs.max_number_of_cells)
{
	rhs.current_ptr = nullptr;
	rhs.data_ptr = nullptr;
...
template <class Ty, class _Allocator>
welp::acc_const_buffer<Ty, _Allocator>& welp::acc_const_buffer<Ty, _Allocator>::operator=(welp::acc_const_buffer<Ty, _Allocator>&& rhs) noexcept
{
	delete_buffer();
...
template <class Ty, class _Allocator>
welp::acc_const_buffer<Ty, _Allocator>::~acc_const_buffer()
{
	delete_buffer();
}
