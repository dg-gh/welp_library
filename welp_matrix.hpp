...
#if defined(WELP_MATRIX_DEBUG_MODE) || defined(WELP_ALWAYS_DEBUG_MODE)
#include <cassert>
#ifndef WELP_MATRIX_INCLUDE_IOSTREAM
#define WELP_MATRIX_INCLUDE_IOSTREAM
...
namespace welp
{
	...
	template <typename Ty, class _Allocator> bool operator==(const welp::matrix<Ty, _Allocator>& A, Ty x) noexcept;
	template <typename Ty, class _Allocator> bool operator!=(const welp::matrix<Ty, _Allocator>& A, Ty x) noexcept;
	template <typename Ty, class _Allocator> bool operator<(const welp::matrix<Ty, _Allocator>& A, Ty x) noexcept;
	template <typename Ty, class _Allocator> bool operator>(const welp::matrix<Ty, _Allocator>& A, Ty x) noexcept;
	template <typename Ty, class _Allocator> bool operator<=(const welp::matrix<Ty, _Allocator>& A, Ty x) noexcept;
