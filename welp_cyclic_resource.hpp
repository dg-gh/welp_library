...
#if defined(WELP_ALWAYS_INCLUDE_ALL) || defined(WELP_CYCLIC_RESOURCE_INCLUDE_ALL) || defined(WELP_CYCLIC_INCLUDE_ALL)
...
#if defined(WELP_ALWAYS_DEBUG_MODE) || defined(WELP_CYCLIC_RESOURCE_DEBUG_MODE)
#ifndef WELP_CYCLIC_DEBUG_MODE
