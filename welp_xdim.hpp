...
namespace welp
{
	...
	public:
		...
		xdim_ref(const welp::xdim_ref<Ty, dim>& rhs) = delete;
		welp::xdim_ref<Ty, dim>& operator=(const welp::xdim<Ty, dim>& rhs) = delete;
		xdim_ref(welp::xdim_ref<Ty, dim>&& rhs) = delete;
		welp::xdim<Ty, dim>& operator=(welp::xdim<Ty, dim>&& rhs) = delete;
		~xdim_ref() = default;
	...
	public:
		...
		xdim_const_ref(const welp::xdim_const_ref<Ty, dim>& rhs) = delete;
		welp::xdim_const_ref<Ty, dim>& operator=(const welp::xdim<Ty, dim>& rhs) = delete;
		xdim_const_ref(welp::xdim_const_ref<Ty, dim>&& rhs) = delete;
		welp::xdim<Ty, dim>& operator=(welp::xdim<Ty, dim>&& rhs) = delete;
		~xdim_const_ref() = default;
