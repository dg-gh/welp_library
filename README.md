...
- **welp_interpreter.hpp** : Wraps arrays of std::uint8_t into a class where bits and hexadecimals can be accessed and modified individually. Starting from a memory space of one byte. Needs little-endian memory layout.
